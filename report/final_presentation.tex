...
\begin{frame}{Discussion}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{columns}
    \vspace{0.06cm}
    \includegraphics[width=\linewidth]{reconstruction_panel_q3_kodim03_zoom_only.png}

    \vspace{0.12cm}
    {\small\color{Stone}\centering no visible difference at quality 3\par}

    \column{0.38\textwidth}
    \begin{alertblock}{Discussion}
      \small
      \begin{itemize}
        \item No visible SE gain
        \item Coded bitrate corrected the story
        \item Weak SE adapters; priors matter more
      \end{itemize}
    \end{alertblock}
  \end{columns}
\end{frame}
...
\begin{frame}{Conclusion}
  ...
  \begin{exampleblock}{If I Continued This Project}
    Run multiple seeds, train an MS-SSIM-optimized variant, and test richer attention placement or stronger entropy models.
  \end{exampleblock}
\end{frame}
